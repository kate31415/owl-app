...
from user import ProgressTracker
from games import WordGuessGame
import json
import os
import textwrap
import datetime
...
class App(customtkinter.CTk):
    ...
    def user_menu(self):
        ...
        play_game_button = customtkinter.CTkButton(self, text="Играть в угадайку", command=self.play_guess_game)
    ...
    def show_word_info(self, word):
        ...
        label.pack(pady=10)
        definition_label = customtkinter.CTkLabel(word_info_window, text=textwrap.fill(definition, width=40), font=("Arial", 14))
        ...
        example_label = customtkinter.CTkLabel(word_info_window, text=textwrap.fill(example, width=40), font=("Arial", 14))
    ...
    def play_guess_game(self):
        try:
            game = WordGuessGame(self.current_user)
            game.play_game()
